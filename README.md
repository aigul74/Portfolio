...
|   8.   |[Анализ тарифов мобильного оператора](http://example.com/link "Я ссылка")| На основании анализа поведения клиентов, сделать вывод — какой тариф лучше и приносит больше денег.
               |Python, Pandas,Scipy|
